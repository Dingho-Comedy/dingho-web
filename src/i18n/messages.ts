...
const MESSAGES: Record<Locale, HomeMessages> = {
  ...
  en: {
    ...
    heroTagline: "Boston’s first Chinese comedy club",
    heroCta: "Get tickets",
    programBadge: "SHOWS",
    ...
    aboutCta: "Message Dinghao on WeCom",
    aboutFanGalleryAria: "Community photos",
    appleAlt: "Dinghao Comedy playlist artwork",
    appleTitle: "Opening Laughs",
    appleSubtitle: "Dinghao Comedy pre-show playlist",
    appleBtnAria: "Open the Dinghao Opening Laughs playlist on Apple Music",
    faqBadge: "FAQ",
    faqHeading: "FAQ",
